...
import 'package:gym_app/utils/config.dart';
import 'package:gym_app/widgets/pay_page_widget.dart';
import 'package:tosspayments_widget_sdk_flutter/model/payment_info.dart';
import 'package:tosspayments_widget_sdk_flutter/model/payment_widget_options.dart';

/// [WidgetHome] 위젯은 사용자에게 결제 수단 및 주문 관련 정보를 입력받아
/// 결제를 시작하는 화면을 제공합니다.
class PayWidgetHome extends StatefulWidget {
  /// 기본 생성자입니다.
  const PayWidgetHome({super.key});

  @override
  PayWidgetHomeState createState() => PayWidgetHomeState();
}

/// [PayWidgetHomeState]는 [PayWidgetHome] 위젯의 상태를 관리하는 클래스입니다.
class PayWidgetHomeState extends State<PayWidgetHome> {
